...
If you'd rather have a blank than a bold header in the script, use `# \ ` to terminate the slide. (An empty header is eliminated by knitting.) A new slide also terminates the previous slide, as in the following examples.
...
On the script, the `textpos` grid is shrunk down. Note too that `textblock`s take up no vertical space, so to prevent overprinting in the script you must manually insert some vertical space. Unfortunately.
